...
show_giono           = false; % TRUE IF YOU WANT TO SEE THAT THE GIONO METJOD GIVES THE CORRECT CENTER
...
[x_fit,y_fit,z_fit,weights_fit] = prepareSurfaceData(X_grid_ganymede_centred_subimage,Y_grid_ganymede_centred_subimage,ganymede_centred_subimage_reyleights,1./sigma_matrix_ganymede_centred_subimage_reyleight.^2);
...
for n0_value=observation.best_n0
    ...
    % ASSESS MODEL ON THE BACKGROUND
    if counter==1 
    ...
    R_grid = sqrt(X_grid_ganymede_centred_subimage.^2 + Y_grid_ganymede_centred_subimage.^2);
    rim_mask = R_grid >=R_ganymede_pixel & R_grid <= R_ganymede_pixel*1.5;
    ...
    [best_col_index_center,best_row_index_center,epsilon_struct] = Giorno_method(ganymede_centred_subimage_reyleights,...
                                                                                 ...
                                                                                 globalParameters.inner_radius_giorno,...
                                                                                 globalParameters.outer_radius_giorno, ...
                                                                                 globalParameters.number_of_bins_for_giornoMethod);
    if show_giono 
        figure
        hold on
        imagesc(epsilon_struct.x_shift,epsilon_struct.y_shift,epsilon_struct.giono_matrix);
        ax = formal_axes(gca());
    ...
    if counter == 1
       ...
       errorbar(boxing_ax1,vertical_range((1:decimation_error_bar:end))/R_ganymede_pixel,ganymede_centred_subimage_vertical_box_plot((1:decimation_error_bar:end)),error_bar_vertical_box_plot((1:decimation_error_bar:end)),'o',"HandleVisibility","off")
    ...
    if counter == 1
       ...
       errorbar(boxing_ax2,horizontal_range((1:decimation_error_bar:end))/R_ganymede_pixel,ganymede_centred_subimage_horizontal_box_plot((1:decimation_error_bar:end)),error_bar_horizontal_box_plot((1:decimation_error_bar:end)),'o',"HandleVisibility","off")
    ...
    [mean_along_bin_ganymede_centred_subimage,center_angles_range_dense,error_per_bin] = radial_bins_average(ganymede_centred_subimage_reyleights,xcenter,ycenter,globalParameters.inner_radius_giorno,globalParameters.outer_radius_giorno,globalParameters.number_of_bins_for_giornoMethod,sigma_matrix_ganymede_centred_subimage_reyleight);
    [mean_along_bin_model_image,center_angles_range]   = radial_bins_average(final_model_image_PSF,xcenter,ycenter,globalParameters.inner_radius_giorno,globalParameters.outer_radius_giorno,globalParameters.number_of_bins_for_giornoMethod);
    ...
    if counter ==1 
        ...
        xticks([-180,-135,-90,-45,0,45,90,135]);
    ...
    plot(rim_plot_ax4,center_angles_range,mean_along_bin_model_image,"-ok","DisplayName","Normalized model");
