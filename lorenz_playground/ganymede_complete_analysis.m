...
for n0_value=observation.best_n0
    ...
    rad_mask = radial_range >= R_ganymede_pixel & radial_range <= 1.5*R_ganymede_pixel ;

    chi2_rad     = sum((model_image_radial_plot(rad_mask)         - ganymede_centred_subimage_radial_plot(rad_mask)        ).^2./error_bar_radial_plot(rad_mask).^2  )/numel(model_image_radial_plot(rad_mask));
